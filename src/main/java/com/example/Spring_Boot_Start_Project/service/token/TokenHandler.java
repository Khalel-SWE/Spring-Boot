package com.example.Spring_Boot_Start_Project.service.token;

import com.example.Spring_Boot_Start_Project.dto.AccountDto;
import com.example.Spring_Boot_Start_Project.helper.JwtToken;
...
public class TokenHandler {
    ...
    public String createToken(AccountDto accountDto) {
        ...
        jwtBuilder.claim("roles", accountDto.getRoles().stream().map(roleDto ->
                roleDto.getRoleName()).collect(Collectors.toList()));
